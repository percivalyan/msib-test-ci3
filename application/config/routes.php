...
// Define routes for Lokasi CRUD operations
$route['lokasi'] = 'lokasi/index';        // Display the list of locations
$route['lokasi/create'] = 'lokasi/create'; // Show form to create a new location
$route['lokasi/store'] = 'lokasi/store';   // Handle the submission of the new location form
